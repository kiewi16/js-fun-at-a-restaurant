...
function evaluateinStock(inStock) {
    if (inStock < 20) {
        return true; 
    } else {
        return false;
...
var shouldOrderMore = evaluateinStock(inStock)
...
var vegetables = ['Carrot', 'Potato', 'Onion', 'Lettuce', 'Cucumber']
...
var fruits = ['Oranges', 'Apples', 'Bananas', 'Peaches', 'Strawberries', 'Watermelon', "Blueberries" ]
...
// Other key value pairs that would make sense to add to this object address and hours.
